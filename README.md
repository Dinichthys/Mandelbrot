...
<details>
<summary> Если ссылка не работает, можно посмотреть на скриншот расчётного цикла с этого сайта: </summary>

<img src="data/Array_GodBolt.png" alt="Фото">
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <details>
            <summary>Если ссылка не работает, можно посмотреть на скриншот расчётного цикла с этого сайта:</summary>
            <img src="data/ThreeIterLoopUnrollGodBolt.png" alt="Фото">
            </details>
            </td>
        </tr>
        <tr>
            ...
            <details>
            <summary>Если ссылка не работает, можно посмотреть на скриншот расчётного цикла с этого сайта:</summary>
            <img src="data/FourIterLoopUnrollGodBolt.png" alt="Фото">
            </details>
            </td>
        </tr>
        <tr>
            ...
            <details>
            <summary>Если ссылка не работает, можно посмотреть на скриншот расчётного цикла с этого сайта:</summary>
            <img src="data/FiveIterLoopUnrollGodBolt.png" alt="Фото">
            </details>
            </td>
        </tr>
    </tbody>
